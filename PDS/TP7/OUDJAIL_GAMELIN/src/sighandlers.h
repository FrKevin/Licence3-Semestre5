...
/** Cette fonction est un handler qui permet de traiter le signal SIG_CHILD
...
/** Cette fonction est un handler qui permet de traiter le signal SIG_INT
...
/** Cette fonction est un handler qui permet de traiter le signal SIG_STP
...
/**
   Cette fonction permet de blocker les signaux SIG_CHILD, SIG_INT, SIG_STP
